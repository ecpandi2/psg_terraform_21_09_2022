...
variable "vpc_id_map" {
  type = map(string)
  default = {
    dev = "vpc-0476760022543f8ce" // Dev VPC: vpc-psg-psd-horizon-dev-2_euw1
...
variable "public_subnets_map" {
  ...
  default = {
    dev = ["subnet-0b8e5d8805372ba31", "subnet-0ed748548ec340fef", "subnet-0cde09bfe3fc3060d"]
...
variable "private_subnets_map" {
  ...
  default = {
    dev = ["subnet-0f35a700fb4fb774e","subnet-09dc95f3131753d57","subnet-09edefc28a04aec49"]
...
variable "public_private_map" {
  ...
  default = {
    dev = ["subnet-0b8e5d8805372ba31", "subnet-0ed748548ec340fef", "subnet-0cde09bfe3fc3060d","subnet-0f35a700fb4fb774e","subnet-09dc95f3131753d57","subnet-09edefc28a04aec49" ]
    #   tst = ["subnet-034a21c0e1ba3333d", "subnet-05d343c077166576d", "subnet-07e12869dcb7337a6"]
    #   stg = ["subnet-050552df4a10b6cc2", "subnet-04b905afda4bc52c0", "subnet-098d0359d145a2b61"]
    #   dem = ["subnet-0be7343d976b8214d", "subnet-0e48b317c06ffbd3d", "subnet-0ed521cb0a07d621b"]
    #   pro = ["subnet-0441495ac48152574a", "subnet-00475205bfa111591"]
